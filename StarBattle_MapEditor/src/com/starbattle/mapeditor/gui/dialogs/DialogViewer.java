...
public class DialogViewer {
	...
	public static Map showLoadMapDialog() {
		MapLoadDialog dialog = new MapLoadDialog(StarbattleMapEditor.mapsFolder);
		return dialog.show();
	}

	public static void showSaveMapDialog(Map map) {
		MapSaveDialog dialog = new MapSaveDialog(StarbattleMapEditor.mapsFolder);
		dialog.show(map);
	}

	public static boolean showLayerSettingsDialog(MapLayer layer) {
		EditLayerDialog dialog = new EditLayerDialog(layer);
		JOptionPane.showOptionDialog(null, dialog.getView(), "Edit Layer", JOptionPane.DEFAULT_OPTION,
	...
	public static Map showNewMapDialog() {
		...
		int answer = JOptionPane.showConfirmDialog(null, dialog.getView(), "New Map", JOptionPane.OK_CANCEL_OPTION,
	...
	public static boolean showNewLayerDialog(Map map) {
		...
		int answer = JOptionPane.showConfirmDialog(null, dialog.getView(), "New Layer", JOptionPane.OK_CANCEL_OPTION,
				JOptionPane.PLAIN_MESSAGE);
		if (answer == JOptionPane.OK_OPTION) {
