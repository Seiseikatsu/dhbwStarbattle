...
public class AccountManagerTest {
    ...
    public static void setUpBeforeClass() throws AccountException {
        ...
        assertTrue("Registration successful", facade.canRegisterAccount(account5).equals(RegisterState.Accountname_Invalid));
        assertTrue("Registration successful", facade.canRegisterAccount(account6).equals(RegisterState.Displayname_Invalid));
    ...
    public void userAlreadyExists() {
        assertTrue("Registration not successful", facade.canRegisterAccount(account2).equals(RegisterState.Accountname_Exists));
    }

    @Test
    public void loginTest() throws AccountException {
        assertTrue(facade.canLogin("Geraldine1", "RufeMichAn!:)2").equals(LoginState.Login_Ok));
        assertTrue(facade.canLogin("Nene", "RufeMichAn!:)2").equals(LoginState.Wrong_Username));
        assertTrue(facade.canLogin("Geraldine1", "xxx").equals(LoginState.Wrong_Password));
    }
